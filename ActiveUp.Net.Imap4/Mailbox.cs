...
namespace ActiveUp.Net.Mail
{
    ...
    public class Mailbox : IMailbox
    {
		...
		int _recent,_messageCount,_unseen;
        UInt32 _uidvalidity;
        ...
        public string UidAddFlags(UInt32 uid, IFlagCollection flags)
		{
            return this.SourceClient.Command("uid store " + uid.ToString() + " +flags " + ((FlagCollection)flags).Merged);
		}

        private delegate string DelegateUidAddFlags(UInt32 uid, IFlagCollection flags);
        private DelegateUidAddFlags _delegateUidAddFlags;

        public IAsyncResult BeginUidAddFlags(UInt32 uid, IFlagCollection flags, AsyncCallback callback)
        {
        ...
        public string UidRemoveFlags(UInt32 uid, ActiveUp.Net.Mail.IFlagCollection flags)
		{
            return this.SourceClient.Command("uid store " + uid.ToString() + " -flags " + ((FlagCollection)flags).Merged);
		}

        private delegate string DelegateUidRemoveFlags(UInt32 uid, IFlagCollection flags);
        private DelegateUidRemoveFlags _delegateUidRemoveFlags;

        public IAsyncResult BeginUidRemoveFlags(UInt32 uid, IFlagCollection flags, AsyncCallback callback)
        {
        ...
        public string UidSetFlags(UInt32 uid, ActiveUp.Net.Mail.IFlagCollection flags)
		{
            return this.SourceClient.Command("uid store " + uid.ToString() + " flags " + ((FlagCollection)flags).Merged);
		}

        private delegate string DelegateUidSetFlags(UInt32 uid, IFlagCollection flags);
        private DelegateUidSetFlags _delegateUidSetFlags;

        public IAsyncResult BeginUidSetFlags(UInt32 uid, IFlagCollection flags, AsyncCallback callback)
        {
        ...
        public void UidAddFlagsSilent(UInt32 uid, IFlagCollection flags)
		{
            this.SourceClient.Command("uid store " + uid.ToString() + " +flags.silent " + ((FlagCollection)flags).Merged);
		}

        private delegate void DelegateUidAddFlagsSilent(UInt32 uid, IFlagCollection flags);
        private DelegateUidAddFlagsSilent _delegateUidAddFlagsSilent;

        public IAsyncResult BeginUidAddFlagsSilent(UInt32 uid, IFlagCollection flags, AsyncCallback callback)
        {
        ...
        public void UidRemoveFlagsSilent(UInt32 uid, ActiveUp.Net.Mail.IFlagCollection flags)
		{
            this.SourceClient.Command("uid store " + uid.ToString() + " -flags.silent " + ((FlagCollection)flags).Merged);
		}

        private delegate void DelegateUidRemoveFlagsSilent(UInt32 uid, IFlagCollection flags);
        private DelegateUidRemoveFlagsSilent _delegateUidRemoveFlagsSilent;

        public IAsyncResult BeginUidRemoveFlagsSilent(UInt32 uid, IFlagCollection flags, AsyncCallback callback)
        {
        ...
        public void UidSetFlagsSilent(UInt32 uid, ActiveUp.Net.Mail.IFlagCollection flags)
		{
            this.SourceClient.Command("uid store " + uid.ToString() + " flags.silent " + ((FlagCollection)flags).Merged);
		}

        private delegate void DelegateUidSetFlagsSilent(UInt32 uid, IFlagCollection flags);
        private DelegateUidSetFlagsSilent _delegateUidSetFlagsSilent;

        public IAsyncResult BeginUidSetFlagsSilent(UInt32 uid, IFlagCollection flags, AsyncCallback callback)
        {
		...
		public void UidCopyMessage(UInt32 uid, string destinationMailboxName)
		{
			this.SourceClient.Command("uid copy "+uid.ToString()+" \""+destinationMailboxName+"\"");
		}

        private delegate void DelegateUidCopyMessage(UInt32 uid, string destinationMailboxName);
        private DelegateUidCopyMessage _delegateUidCopyMessage;

        public IAsyncResult BeginUidCopyMessage(UInt32 uid, string destinationMailboxName, AsyncCallback callback)
        {
        ...
        public void UidMoveMessage(UInt32 uid, string destinationMailboxName)
        {
            this.UidCopyMessage(uid, destinationMailboxName);
            this.UidDeleteMessage(uid, true);
        }

        private delegate void DelegateUidMoveMessage(UInt32 uid, string destinationMailboxName);
        private DelegateUidMoveMessage _delegateUidMoveMessage;

        public IAsyncResult BeginUidMoveMessage(UInt32 uid, string destinationMailboxName, AsyncCallback callback)
        {
		...
		public void UidDeleteMessage(UInt32 uid, bool expunge)
		{	
			ActiveUp.Net.Mail.FlagCollection flags = new ActiveUp.Net.Mail.FlagCollection();
			flags.Add("Deleted");
        ...
        private delegate void DelegateUidDeleteMessage(UInt32 uid, bool expunge);
        private DelegateUidDeleteMessage _delegateUidDeleteMessage;

        public IAsyncResult BeginUidDeleteMessage(UInt32 uid, bool expunge, AsyncCallback callback)
        {
