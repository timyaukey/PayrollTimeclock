...
namespace ActiveUp.Net.Mail
{
    ...
    public class Imap4Client : System.Net.Sockets.TcpClient
    {
        ...
        public event ActiveUp.Net.Mail.UidMessageRetrievingEventHandler UidMessageRetrieving;
        /// <summary>
        ...
        public event ActiveUp.Net.Mail.UidMessageRetrievedEventHandler UidMessageRetrieved;
        /// <summary>
        ...
        public event ActiveUp.Net.Mail.UidHeaderRetrievingEventHandler UidHeaderRetrieving;
        /// <summary>
        ...
        public event ActiveUp.Net.Mail.UidHeaderRetrievedEventHandler UidHeaderRetrieved;
        /// <summary>
        ...
        internal void OnUidMessageRetrieving(ActiveUp.Net.Mail.UidMessageRetrievingEventArgs e)
        {
            if (UidMessageRetrieving != null) UidMessageRetrieving(this, e);
            ActiveUp.Net.Mail.Logger.AddEntry("Retrieving message at UID " + e.MessageUid + "...", 2);
        }
        ...
        internal void OnUidMessageRetrieved(ActiveUp.Net.Mail.UidMessageRetrievedEventArgs e)
        {
            if (UidMessageRetrieved != null) UidMessageRetrieved(this, e);
            ActiveUp.Net.Mail.Logger.AddEntry("Retrieved message at UID " + e.MessageUid + ".", 2);
        }
        ...
        internal void OnUidHeaderRetrieving(ActiveUp.Net.Mail.UidHeaderRetrievingEventArgs e)
        {
            if (UidHeaderRetrieving != null) UidHeaderRetrieving(this, e);
            ActiveUp.Net.Mail.Logger.AddEntry("Retrieving Header at UID " + e.MessageUid + "...", 2);
        }
        ...
        internal void OnUidHeaderRetrieved(ActiveUp.Net.Mail.UidHeaderRetrievedEventArgs e)
        {
            if (UidHeaderRetrieved != null) UidHeaderRetrieved(this, e);
            ActiveUp.Net.Mail.Logger.AddEntry("Retrieved Header at UID " + e.MessageUid + ".", 2);
        }
        ...
        public Mailbox SelectMailbox(string mailboxName)
        {
            ...
            // uid validity.
            UInt32 uidValidity = 0;
            try { uidValidity = System.Convert.ToUInt32(ActiveUp.Net.Mail.Imap4Client.FindLine(lines, "[UIDVALIDITY ").Split(' ')[3].TrimEnd(']')); }
            catch (Exception) { }
        ...
        public Mailbox ExamineMailbox(string mailboxName)
        {
            ...
            mailbox.UidValidity = System.Convert.ToUInt32(ActiveUp.Net.Mail.Imap4Client.FindLine(lines, "[UIDVALIDITY ").Split(' ')[3].TrimEnd(']'));
