...
#region Events Handling
    ...
    public delegate void UidMessageRetrievingEventHandler(object sender, ActiveUp.Net.Mail.UidMessageRetrievingEventArgs e);
    /// <summary>
    ...
    public delegate void UidMessageRetrievedEventHandler(object sender, ActiveUp.Net.Mail.UidMessageRetrievedEventArgs e);
    /*/// <summary>
    ...
    public delegate void UidHeaderRetrievingEventHandler(object sender, ActiveUp.Net.Mail.UidHeaderRetrievingEventArgs e);
    /// <summary>
    ...
    public delegate void UidHeaderRetrievedEventHandler(object sender, ActiveUp.Net.Mail.UidHeaderRetrievedEventArgs e);
    /// <summary>
    ...
    /// <summary>
    /// EventArgs used by the UidMessageRetrieved event.
    /// </summary>
#if !PocketPC
    [System.Serializable]
#endif
    public class UidMessageRetrievedEventArgs : System.EventArgs
    {
        byte[] _data;
        UInt32 _uid;
        int _totalCount;
        ...
        /// <param name="index">The index of the message that has been retrieved.</param>
        /// <param name="totalCount">The total amount of messages on the remote server (POP3 only).</param>
        public UidMessageRetrievedEventArgs(byte[] data, UInt32 uid, int totalCount)
        {
            this._data = data;
            this._uid = uid;
            this._totalCount = totalCount;
        ...
        /// <param name="data">The retrieved message as a byte array.</param>
        /// <param name="index">The index of the message that has been retrieved.</param>
        public UidMessageRetrievedEventArgs(byte[] data, UInt32 uid)
        {
            this._data = data;
            this._uid = uid;
            this._totalCount = -1;
    ...
    /// <summary>
    /// EventArgs used by the UidMessageRetrieving event.
    /// </summary>
#if !PocketPC
    [System.Serializable]
#endif
    public class UidMessageRetrievingEventArgs : System.EventArgs
    {
        UInt32 _uid;
        int _totalCount;
        ...
        /// Constructor.
        /// </summary>
        /// <param name="uid">The message to be retrieved's UID.</param>
        /// <param name="totalCount">The total amount of messages on the remote server.</param>
        public UidMessageRetrievingEventArgs(UInt32 uid, int totalCount)
        {
            this._uid = uid;
            this._totalCount = totalCount;
        }
        ...
        /// </summary>
        /// <param name="index">The message to be retrieved's index.</param>
        public UidMessageRetrievingEventArgs(UInt32 uid)
        {
            this._uid = uid;
            this._totalCount = -1;
        }
    ...
    [System.Serializable]
#endif
    public class UidHeaderRetrievedEventArgs : System.EventArgs
    {
        byte[] _data;
        UInt32 _uid;
        int _totalCount = -1;
        ...
        /// <param name="index">The index of the Header retrieved.</param>
        /// <param name="totalCount">The total amount of messages on the remote server (POP3 only).</param>
        public UidHeaderRetrievedEventArgs(byte[] data, UInt32 uid, int totalCount)
        {
            this._uid = uid;
            this._totalCount = totalCount;
            this._data = data;
        ...
        /// <param name="data">The retrieved Header as a byte array.</param>
        /// <param name="index">The index of the retrieved header.</param>
        public UidHeaderRetrievedEventArgs(byte[] data, UInt32 uid)
        {
            this._uid = uid;
            this._data = data;
            this._totalCount = -1;
    ...
    [System.Serializable]
#endif
    public class UidHeaderRetrievingEventArgs : System.EventArgs
    {
        UInt32 _uid;
        int _totalCount = -1;
        ...
        /// Constructor.
        /// </summary>
        public UidHeaderRetrievingEventArgs(UInt32 uid, int totalCount)
        {
            this._uid = uid;
            this._totalCount = totalCount;
        }
        ...
        /// Constructor.
        /// </summary>
        public UidHeaderRetrievingEventArgs(UInt32 uid)
        {
            this._uid = uid;
        }
        /// <summary>
